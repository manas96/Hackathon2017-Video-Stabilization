    ...
    ui(new Ui::MainWindow)
{
    ...
    original_stream = new Player(URL_ORIGINAL);
    stabilized_stream = new Player(URL_STABILIZED);
    ...
    FPS_ORIGINAL = original_stream->getFPS();
    fps_original = FPS_ORIGINAL;

    FPS_STABILIZED = stabilized_stream->getFPS();
